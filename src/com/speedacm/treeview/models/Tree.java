...
public class Tree
{
	...
	public Tree(int id, int sid, GeoPoint point, float dbh, float height, float greenwt, float drywt, int age, float co2seqtot, float co2seqyr, float vol, float crownarea, float carbonwt)
	{
		mID = id;
		mSID = sid;
		mLatLong = point;
